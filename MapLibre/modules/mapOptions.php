...
<div class="card float-start mt-1 ms-1 z-1 rubik-font d-none" id="mapOptions">
    <div class="card-header">
        ...
        <select class="form-select form-select-sm rounded-pill" id="mapStyle">
            <optgroup label="Light">
                <option value="liberty" selected>🗺️ Liberty</option>
    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <label class="form-check-label me-2" for="serversPrs">
                <i class="bi bi-geo-alt-fill" style="color: #FF671F;"></i> Live Servers
            </label>
            <span class="badge rounded-pill bg-warning-subtle text-warning-emphasis ms-auto me-2" id="cntPrs"></span>
            <div class="form-check form-switch m-0">
                <input class="form-check-input" type="checkbox" id="serversPrs" checked>
            </div>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <label class="form-check-label me-2" for="serversAbs">
                <i class="bi bi-geo-alt-fill" style="color: #0098E0;"></i> No Servers
            </label>
            <span class="badge rounded-pill bg-info-subtle text-info-emphasis ms-auto me-2" id="cntAbs"></span>
            <div class="form-check form-switch m-0">
    ...
    <div class="card-footer">
        <span class="d-flex">
            ...
            <attr data-bs-toggle="tooltip" data-bs-html="true"
                title="Toggles label layers on the current <code><strong>OpenFreeMap</strong></code> style.">
